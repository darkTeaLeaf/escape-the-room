...
-- | Draw exit tile
exitTile :: Picture
exitTile = colored black (solidRectangle 0.20 0.20) 
...
buttonTile color = colored (doorColorToColor color) (solidCircle 0.25)
                   <> floorTile
                   
-- | Draw door tile
doorTile :: DoorColor -> Picture
doorTile color = colored (doorColorToColor color) (solidCircle 0.25)
                 <> wallTile
